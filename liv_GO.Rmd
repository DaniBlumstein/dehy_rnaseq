...
SigGeneWrapper(liv_res_trt, 0.05, "all")
summary(liv_res_trt)
...
```{r}
up_liv <- filter(as.data.frame(restrt_liv), log2FoldChange > 0, padj < 0.05)
...
down_liv <- filter(as.data.frame(restrt_liv), log2FoldChange < 0, padj < 0.05)
