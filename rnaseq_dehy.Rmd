...
out_ind1 <- df_species %>% filter(CCA1 > sd*3)
out_ind2 <- df_species %>% filter(CCA1 < -(sd*3))
...
df_environ  <- scores(summary(cca_model)$biplot[c(4,7),1:2]) #get the physio vars CC1 and CC2 scores
