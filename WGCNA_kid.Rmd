...
############### GO enrichment #################
library(gprofiler2)
kid_ref <- geneInfo0_kid$gene

kid_wgcna_salmon <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="salmon")]
kid_wgcna_lightcyan <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="lightcyan")]
kid_wgcna_turquoise <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="turquoise")]
kid_wgcna_cyan <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="cyan")]
kid_wgcna_magenta <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="magenta")]
kid_wgcna_tan <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="tan")]
kid_wgcna_greenyellow <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="greenyellow")]
kid_wgcna_midnightblue <- geneInfo0_kid$gene[which(geneInfo0_kid$moduleColor=="midnightblue")]

kid_wgcna_salmon_GO <- gost(kid_wgcna_salmon, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_salmon_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_salmon_GO.csv")
sink()


kid_wgcna_lightcyan_GO <- gost(kid_wgcna_lightcyan, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_lightcyan_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_lightcyan_GO.csv")
sink()


kid_wgcna_turquoise_GO <- gost(kid_wgcna_turquoise, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_turquoise_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_turquoise_GO.csv")
sink()


kid_wgcna_cyan_GO <- gost(kid_wgcna_cyan, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_cyan_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_cyan_GO.csv")
sink()

kid_wgcna_magenta_GO <- gost(kid_wgcna_magenta, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_magenta_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_magenta_GO.csv")
sink()


kid_wgcna_tan_GO <- gost(kid_wgcna_tan, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_tan_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_tan_GO.csv")
sink()


kid_wgcna_greenyellow_GO <- gost(kid_wgcna_greenyellow, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_greenyellow_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_greenyellow_GO.csv")
sink()


kid_wgcna_midnightblue_GO <- gost(kid_wgcna_midnightblue, organism = "hsapiens", 
                     ordered_query = F, significant = T, exclude_iea = T,
                     correction_method = "bonferroni",
                     custom_bg = kid_ref)
gostplot(kid_wgcna_midnightblue_GO, capped = TRUE, interactive = TRUE)
sink(file = "results/WGCNAresults/kid_wgcna_midnightblue_GO.csv")
sink()
```
